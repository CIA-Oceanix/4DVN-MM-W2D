...
class HistogrammizationDirect(nn.Module):
    def __init__(self, in_channels, out_channels, shape_data, lr_kernelsize, wind_bins):
        ...
        self.conv2d_relu_cascade = nn.Sequential(
            nn.Conv2d(in_channels, 256, kernel_size = (10,10), stride = 10),
            nn.ReLU(),
            nn.Conv2d(256, out_channels, kernel_size = (10,10), stride = 10),
            nn.ReLU(),
            nn.Conv2d(out_channels, out_channels, kernel_size = (10,10), stride = 10)
        )
